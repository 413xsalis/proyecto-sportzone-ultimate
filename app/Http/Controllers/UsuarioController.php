...
class UsuarioController extends Controller
{
    ...
    {
        // Puedes precargar los roles si quieres, aunque Spatie los maneja bien.
    ...
    public function update(Request $request, User $usuario)
    {
        $request->validate([
            'name' => ['required', 'string', 'max:255'],
            // La regla unique ignora el ID del usuario actual para evitar conflictos al editar
        ...
        $usuario->update($request->except('password')); // No actualices la contraseña aquí a menos que sea un campo específico
    ...
    {
        // Spatie se encarga automáticamente de limpiar las relaciones de roles
        // cuando el usuario es eliminado, gracias a las claves foráneas en la migración.
        $usuario->delete();
