...
@section('content')
  <main class="content">
    <div class="app-title">
      <div>
        <h1><i class="bi bi-person-circle"></i> Perfil de Usuario</h1>
      </div>
    ...
    <div class="profile-header" style="background: linear-gradient(135deg, #0062cc, #0095ff); color: white; padding: 2rem 0; margin-bottom: 2rem;">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-2 text-center">
            <div class="avatar-container" style="position: relative; width: 150px; height: 150px; margin: 0 auto;">
              <img src="{{ Auth::user()->foto_perfil ? asset('storage/' . Auth::user()->foto_perfil) : 'https://via.placeholder.com/150' }}" 
                   class="avatar rounded-circle" id="profileAvatar" style="width: 100%; height: 100%; object-fit: cover; border: 5px solid white; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
              <div class="avatar-edit" data-bs-toggle="modal" data-bs-target="#uploadLogoModal" style="position: absolute; bottom: 5px; right: 5px; background: #0062cc; color: white; border-radius: 50%; width: 36px; height: 36px; display: flex; align-items: center; justify-content: center; cursor: pointer;">
          ...
          <div class="col-md-3 text-md-end">
            <img src="{{ Auth::user()->logo_personalizado ? asset('storage/' . Auth::user()->logo_personalizado) : 'https://via.placeholder.com/80x40?text=Logo' }}" 
            ...
            <button class="btn btn-light btn-sm" data-bs-toggle="modal" data-bs-target="#uploadLogoModal">
              <i class="bi bi-pencil me-1"></i> Cambiar Logo
            </button>
          </div>
        </div>
      </div>
    ...
    <div class="container mb-5">
      <div class="row">
        <div class="col-md-3">
          <div class="card">
            <div class="card-body">
              <div class="d-flex flex-column nav-pills" id="v-pills-tab" role="tablist">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">Cambiar logo/foto de perfil</h5>
          ...
          <div class="modal-body">
            <form action="{{ route('perfilinst.uploadLogo') }}" method="POST" enctype="multipart/form-data" id="logoForm">
              ...
              <div class="form-check mb-3">
                <input class="form-check-input" type="checkbox" id="useAsProfile" name="use_as_profile">
                <label class="form-check-label" for="useAsProfile">
                  Usar también como foto de perfil
                </label>
              </div>
            </form>
          </div>
